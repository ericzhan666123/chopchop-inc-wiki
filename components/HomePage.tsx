...
export function HomePage({locale}:{locale:Locale}) {
  ...
  const browse=[
    [de?"Rezepte":"Recipes",visibleRecipes.length,"/recipes"],[de?"Gegenstände":"Items",items.length,"/items"],[de?"Bäume":"Trees",trees.length,"/trees"],
    [de?"Gummienten":"Rubber Ducks",ducks.length,"/ducks"],[de?"Zielgruppen":"Audiences",audiences.length,"/audiences"],["NPCs",npcs.length,"/npcs"],
  ] as const;
